...
export const projects = [
  ...
  {
    slug: 'claudecompanion',
    name: 'ClaudeCompanion',
    tagline: 'Drive Claude Code from your phone without the code leaving your machine.',
    year: '2026',
    tier: 'major',
    category: 'ai-tooling',
    status: 'in progress',
    description:
      'A mobile and desktop companion for Claude Code, so you can manage an AI coding session when you are away from the machine running it. Monitor the live session, steer it with prompts, review the changes it wants to make, and approve or reject its actions from your phone. The security line is the whole point: project files, terminal access, credentials and code execution stay on your machine — the phone is a remote control, not a second copy of the repo.',
    highlights: [
      'Remote session monitoring and prompt steering, with approval handling for actions the agent wants to take.',
      'Change review before anything is applied, so you are not rubber-stamping diffs you cannot see.',
      'Trusted-device access and reconnection, so a dropped connection does not lose the session.',
      'Deliberately keeps files, terminal and credentials on the developer machine — the companion never becomes a place your code lives.',
    ],
    tech: ['Flutter', 'Dart', 'Remote control', 'Device trust', 'Push notifications'],
    links: [],
  },
  {
    slug: 'codexcompanion',
    name: 'CodexCompanion',
    tagline: 'The same remote-control idea for Codex, with a Rust bridge on the machine.',
    year: '2026',
    tier: 'major',
    category: 'ai-tooling',
    status: 'in progress',
    description:
      'A secure companion app for monitoring and controlling Codex sessions from a phone or a second desktop. Follow live activity, review code changes, approve actions, send follow-up prompts and reconnect to sessions, while managing several trusted machines from one app. Execution and repository data never leave the developer machine. The build splits cleanly across three tiers: a Flutter client, a Rust desktop bridge that does the local work, and a thin Cloudflare backend that only carries connectivity, notifications, device management and subscriptions.',
    highlights: [
      'Three-tier split with a clear trust boundary: the Rust bridge holds everything sensitive locally, the Cloudflare layer is deliberately thin and code-blind.',
      'Manage multiple trusted computers from one app, each paired rather than sharing a blanket credential.',
      'Live activity, change review, action approval and prompt steering, the same control surface as ClaudeCompanion, targeting Codex.',
      'Cloudflare backend handles remote connectivity, notifications, device management and subscriptions — and nothing else.',
    ],
    tech: ['Flutter', 'Dart', 'Rust', 'Cloudflare Workers', 'Device management'],
    links: [],
  },
  {
    slug: 'tasktracker',
...
const PROC = {
  ...
  claudecompanion: { pid: 18, stat: 'R', cpu: 26.0, uptime: '1mo' },
  codexcompanion: { pid: 19, stat: 'R', cpu: 24.0, uptime: '1mo' },
